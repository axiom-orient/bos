...
struct ApplyEngineIntegrationTests {
    ...
    @Test func initModeGeneratesTuistScaffoldAndManagedBlock() throws {
        ...
        #expect(appProjectText.contains(#""CODE_SIGN_STYLE": .string("Manual")"#))
        #expect(appProjectText.contains(#""CODE_SIGN_IDENTITY[sdk=iphoneos*]": .string("Apple Distribution")"#))
        #expect(appProjectText.contains(#""PROVISIONING_PROFILE_SPECIFIER[sdk=iphoneos*]": .string("match AppStore \(appBundleId)")"#))
