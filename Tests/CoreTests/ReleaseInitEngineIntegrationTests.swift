...
struct ReleaseInitEngineIntegrationTests {
    ...
    @Test func releaseInitGeneratesFastlaneFilesAndParsesDefaultLanes() throws {
        ...
        #expect(fastfileContent.contains("private_lane :release_automation_mode do"))
        #expect(fastfileContent.contains("private_lane :submit_delivery_options do"))
        ...
        #expect(fastfileContent.contains("options[:automatic_release] = true"))
        #expect(fastfileContent.contains("options[:phased_release] = true"))
        #expect(fastfileContent.contains("deliver(submit_delivery_options)"))
